...
async def add_income(message: Message):
    ...
    data_manager.user_data[user_id]["transactions"].append({"type": "income", "amount": amount, "description": description})
...
async def add_expense(message: Message):
    ...
    if data_manager.user_data[user_id]["balance"] < amount:
        ...
        return
    data_manager.user_data[user_id]["balance"] -= amount
    data_manager.user_data[user_id]["transactions"].append({"type": "expense", "amount": amount, "description": description})
    data_manager.save_user_data(user_id)
